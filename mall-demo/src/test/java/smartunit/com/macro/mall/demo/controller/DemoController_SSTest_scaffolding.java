...
public class DemoController_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.demo.controller.DemoController"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.demo.dto.PmsBrandDto", false, DemoController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.demo.service.DemoService", false, DemoController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }
