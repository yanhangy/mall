...
public class FlagValidatorClass_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.validator.FlagValidatorClass"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.validator.FlagValidator", false, FlagValidatorClass_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
