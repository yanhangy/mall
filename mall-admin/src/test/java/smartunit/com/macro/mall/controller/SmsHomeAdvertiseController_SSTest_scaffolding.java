...
public class SmsHomeAdvertiseController_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.controller.SmsHomeAdvertiseController"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.model.SmsHomeAdvertise", false, SmsHomeAdvertiseController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.service.SmsHomeAdvertiseService", false, SmsHomeAdvertiseController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(SmsHomeAdvertiseController_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SmsHomeAdvertiseController_SSTest_scaffolding.class.getClassLoader()); 
