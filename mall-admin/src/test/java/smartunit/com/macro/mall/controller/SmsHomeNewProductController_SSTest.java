...
// allCoveredLines:[22, 30, 31, 32, 34, 41, 42, 43, 45, 52, 53, 54, 56, 63, 64, 65, 67, 77, 78]
  ...
  public void test_create_0()  throws Throwable  {
      //caseID:38828c34f45f0d2df4f1a639ec78b026
  ...
  public void test_create_1()  throws Throwable  {
      //caseID:416c87c968516589fe6aa20544186ca4
  ...
  public void test_delete_2()  throws Throwable  {
      //caseID:27ac9cd62d247547c9bd6780e527dfee
  ...
  public void test_delete_3()  throws Throwable  {
      //caseID:0c08efab43e1bec780ecdb7e1b099f78
      ...
      //mock smsHomeNewProductService0
      SmsHomeNewProductService smsHomeNewProductService0 = mock(SmsHomeNewProductService.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(457).when(smsHomeNewProductService0).delete(ArgumentMatchers.<java.lang.Long>anyList());
  ...
  public void test_list_4()  throws Throwable  {
      //caseID:378e6558c2bebf97552f12a25dba209d
      ...
      //Call method: list
      CommonResult<CommonPage<SmsHomeNewProduct>> commonResult0 = smsHomeNewProductController0.list("622", integer0, integer0, integer0);
  ...
  public void test_updateRecommendStatus_5()  throws Throwable  {
      //caseID:d1f0e79462b9a69736f1001f06f503f0
      ...
      //mock smsHomeNewProductService0
      SmsHomeNewProductService smsHomeNewProductService0 = mock(SmsHomeNewProductService.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(535).when(smsHomeNewProductService0).updateRecommendStatus(ArgumentMatchers.<java.lang.Long>anyList() , anyInt());
  ...
  public void test_updateRecommendStatus_6()  throws Throwable  {
      //caseID:3622cd9443a14697af503d96e61bb4c4
  ...
  public void test_updateSort_7()  throws Throwable  {
      //caseID:e260777818d03022ae6aaebd405c7bcb
      ...
      //mock smsHomeNewProductService0
      SmsHomeNewProductService smsHomeNewProductService0 = mock(SmsHomeNewProductService.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(706).when(smsHomeNewProductService0).updateSort(anyLong() , anyInt());
  ...
  public void test_updateSort_8()  throws Throwable  {
      //caseID:bbe1528ecd02d580d998d3822c8e2e2a
