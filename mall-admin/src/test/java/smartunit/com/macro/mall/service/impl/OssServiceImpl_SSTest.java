...
// allCoveredLines:[27, 51, 53, 54, 56, 57, 59, 61, 62, 63, 64, 66, 68, 69, 70, 71, 72, 73, 74, 75, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 91, 92, 93, 94, 95, 96, 97, 98, 99]
  ...
  public void test_callback_0()  throws Throwable  {
      //caseID:8444ff22366fe53de709d0f4f24bef5e
      //CoveredLines: [27, 91, 92, 93, 94, 95, 96, 97, 98, 99]
      //Input_0_HttpServletRequest: {getParameter=" on "}
      //Assert: assertEquals("http://filename=${object}&size=${size}&mimeType=${mimeType}&height=${imageInfo.height}&width=${imageInfo.width}.jU%~#JD/ on ", method_result.getFilename());
      
      OssServiceImpl ossServiceImpl0 = new OssServiceImpl();
      PrivateAccess.setVariable((Class<?>) OssServiceImpl.class, ossServiceImpl0, "ALIYUN_OSS_ENDPOINT", (Object) "jU%~#JD");
      PrivateAccess.setVariable((Class<?>) OssServiceImpl.class, ossServiceImpl0, "ALIYUN_OSS_BUCKET_NAME", (Object) "filename=${object}&size=${size}&mimeType=${mimeType}&height=${imageInfo.height}&width=${imageInfo.width}");
      //mock httpServletRequest0
      HttpServletRequest httpServletRequest0 = mock(HttpServletRequest.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(" on ").when(httpServletRequest0).getParameter(anyString());
      
      //Call method: callback
      OssCallbackResult ossCallbackResult0 = ossServiceImpl0.callback(httpServletRequest0);
      
      //Test Result Assert
      assertEquals("http://filename=${object}&size=${size}&mimeType=${mimeType}&height=${imageInfo.height}&width=${imageInfo.width}.jU%~#JD/ on ", ossCallbackResult0.getFilename());
  }

  @Test(timeout = 4000)
  public void test_policy_1()  throws Throwable  {
      //caseID:c6b34693519a9d2e71090195de7a11fd
      //CoveredLines: [27, 51, 53, 54, 56, 57, 59, 61, 62, 63, 64, 66, 68, 69, 70, 71, 72, 73, 74, 75, 77, 83, 84, 86]
      //Assert: assertNull(method_result.getCallback());
      
      OssServiceImpl ossServiceImpl0 = new OssServiceImpl();
      //mock oSSClient0
      OSSClient oSSClient0 = mock(OSSClient.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("@WebAppConfiguration should only be used with @SpringBootTest when @SpringBootTest is configured with a mock web environment. Please remove @WebAppConfiguration or reconfigure @SpringBootTest.").when(oSSClient0).generatePostPolicy(any(java.util.Date.class) , any(com.aliyun.oss.model.PolicyConditions.class));
  ...
  public void test_policy_2()  throws Throwable  {
      //caseID:4e798a7d2f38725f7217959d9ad70286
      ...
      //mock oSSClient0
      OSSClient oSSClient0 = mock(OSSClient.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("mimeType").when(oSSClient0).calculatePostSignature(anyString());
      doReturn("mimeType").when(oSSClient0).generatePostPolicy(any(java.util.Date.class) , any(com.aliyun.oss.model.PolicyConditions.class));
      ...
      //Test Result Assert
      assertEquals("bWltZVR5cGU=", ossPolicyResult0.getPolicy());
      ...
      //Test Result Assert
      assertEquals("mimeType", ossPolicyResult0.getSignature());
  }
}
