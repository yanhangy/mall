...
// allCoveredLines:[27, 51, 53, 54, 56, 57, 59, 61, 62, 63, 64, 66, 68, 69, 70, 71, 72, 73, 74, 75, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 91, 92, 93, 94, 95, 96, 97, 98, 99]
  ...
  public void test_callback_0()  throws Throwable  {
      //caseID:fcff739d43324c023b3b07b2664c5187
      //CoveredLines: [27, 91, 92, 93, 94, 95, 96, 97, 98, 99]
      //Input_0_HttpServletRequest: {getParameter=\"\"}
      //Assert: assertEquals("http://width.io.netty.util.concurrent.PromiseTask/", method_result.getFilename());
      
      OssServiceImpl ossServiceImpl0 = new OssServiceImpl();
      
      PrivateAccess.setVariable((Class<?>) OssServiceImpl.class, ossServiceImpl0, "ALIYUN_OSS_ENDPOINT", (Object) "io.netty.util.concurrent.PromiseTask");
      
      PrivateAccess.setVariable((Class<?>) OssServiceImpl.class, ossServiceImpl0, "ALIYUN_OSS_BUCKET_NAME", (Object) "width");
      ...
      //Test Result Assert
      assertEquals("http://width.io.netty.util.concurrent.PromiseTask/", ossCallbackResult0.getFilename());
  }

  @Test(timeout = 4000)
  public void test_policy_1()  throws Throwable  {
      //caseID:dc3277c9874e13688274362d1579ffd0
      //CoveredLines: [27, 51, 53, 54, 56, 57, 59, 61, 62, 63, 64, 66, 68, 69, 70, 71, 72, 73, 74, 75, 77, 83, 84, 86]
      //Assert: assertNull(method_result.getAccessKeyId());
  ...
  public void test_policy_2()  throws Throwable  {
      ...
      //Assert: assertEquals("StartWith", method_result.getSignature());
      ...
      doReturn("StartWith").when(credentials0).getAccessKeyId();
      ...
      //mock oSSClient0
      OSSClient oSSClient0 = mock(OSSClient.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("StartWith").when(oSSClient0).calculatePostSignature(anyString());
      doReturn("StartWith").when(oSSClient0).generatePostPolicy(any(java.util.Date.class) , any(com.aliyun.oss.model.PolicyConditions.class));
      ...
      //Test Result Assert
      assertEquals("U3RhcnRXaXRo", ossPolicyResult0.getPolicy());
      ...
      //Test Result Assert
      assertEquals("StartWith", ossPolicyResult0.getSignature());
