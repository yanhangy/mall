...
// allCoveredLines:[27, 51, 53, 54, 56, 57, 59, 61, 62, 63, 64, 66, 68, 69, 70, 71, 72, 73, 74, 75, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 91, 92, 93, 94, 95, 96, 97, 98, 99]
  ...
  public void test_callback_0()  throws Throwable  {
      //caseID:4b77393d7ace68eee4af368431e59e11
      //CoveredLines: [27, 91, 92, 93, 94, 95, 96, 97, 98, 99]
      //Input_0_HttpServletRequest: {getParameter=\"1\"}
      //Assert: assertEquals("http://1., described as [/1", method_result.getFilename());
      
      OssServiceImpl ossServiceImpl0 = new OssServiceImpl();
      
      PrivateAccess.setVariable((Class<?>) OssServiceImpl.class, ossServiceImpl0, "ALIYUN_OSS_ENDPOINT", (Object) ", described as [");
      
      PrivateAccess.setVariable((Class<?>) OssServiceImpl.class, ossServiceImpl0, "ALIYUN_OSS_BUCKET_NAME", (Object) "1");
      ...
      //Test Result Assert
      assertEquals("http://1., described as [/1", ossCallbackResult0.getFilename());
  }

  @Test(timeout = 4000)
  public void test_policy_1()  throws Throwable  {
      //caseID:0b0b452cbf44574735d138dd45d9c1ae
      //CoveredLines: [27, 51, 53, 54, 56, 57, 59, 61, 62, 63, 64, 66, 68, 69, 70, 71, 72, 73, 74, 75, 77, 83, 84, 86]
      //Assert: assertNull(method_result.getSignature());
      
      OssServiceImpl ossServiceImpl0 = new OssServiceImpl();
      //mock oSSClient0
      OSSClient oSSClient0 = mock(OSSClient.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("1.0").when(oSSClient0).generatePostPolicy(any(java.util.Date.class) , any(com.aliyun.oss.model.PolicyConditions.class));
  ...
  public void test_policy_2()  throws Throwable  {
      //caseID:718408ad3d29febfce6b24dd6327fd08
      ...
      //Assert: assertEquals("MS4w", method_result.getPolicy());
      //Assert: assertEquals("1.0", method_result.getSignature());
      ...
      doReturn("1.0").when(credentials0).getAccessKeyId();
      ...
      //mock oSSClient0
      OSSClient oSSClient0 = mock(OSSClient.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("1.0").when(oSSClient0).calculatePostSignature(anyString());
      doReturn("1.0").when(oSSClient0).generatePostPolicy(any(java.util.Date.class) , any(com.aliyun.oss.model.PolicyConditions.class));
      ...
      //Test Result Assert
      assertEquals("MS4w", ossPolicyResult0.getPolicy());
      
      //Test Result Assert
      assertEquals("1.0", ossPolicyResult0.getSignature());
