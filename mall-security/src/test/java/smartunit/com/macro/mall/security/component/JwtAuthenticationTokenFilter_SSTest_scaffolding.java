...
public class JwtAuthenticationTokenFilter_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.security.component.JwtAuthenticationTokenFilter"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.security.util.JwtTokenUtil", false, JwtAuthenticationTokenFilter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.FilterChain", false, JwtAuthenticationTokenFilter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, JwtAuthenticationTokenFilter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, JwtAuthenticationTokenFilter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(JwtAuthenticationTokenFilter_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JwtAuthenticationTokenFilter_SSTest_scaffolding.class.getClassLoader()); 
