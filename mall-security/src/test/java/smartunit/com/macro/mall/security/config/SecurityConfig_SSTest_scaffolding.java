...
public class SecurityConfig_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.security.config.SecurityConfig"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.security.config.SecurityConfig", false, SecurityConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }
