...
public class DynamicAccessDecisionManager_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.security.component.DynamicAccessDecisionManager"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.springframework.security.access.ConfigAttribute", false, DynamicAccessDecisionManager_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.Authentication", false, DynamicAccessDecisionManager_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.GrantedAuthority", false, DynamicAccessDecisionManager_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.authority.SimpleGrantedAuthority", false, DynamicAccessDecisionManager_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(DynamicAccessDecisionManager_SSTest_scaffolding.class.getClassLoader() ,
      "org.springframework.security.core.authority.SimpleGrantedAuthority"
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DynamicAccessDecisionManager_SSTest_scaffolding.class.getClassLoader()); 
