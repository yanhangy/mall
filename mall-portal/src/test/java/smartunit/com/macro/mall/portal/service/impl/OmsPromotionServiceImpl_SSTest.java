...
// allCoveredLines:[25, 32, 34, 36, 37, 38, 39, 40, 41, 42, 44, 45, 46, 47, 49, 50, 52, 53, 54, 55, 56, 57, 58, 59, 61, 62, 63, 64, 65, 66, 67, 68, 70, 71, 72, 73, 74, 75, 76, 77, 78, 80, 82, 84, 85, 86, 87, 88, 89, 90, 91, 93, 94, 95, 96, 97, 98, 99, 100, 101, 103, 105, 107, 109, 110, 117, 118, 119, 120, 121, 128, 129, 130, 131, 132, 133, 134, 136, 138, 139, 146, 147, 148, 149, 150, 151, 152, 153, 154, 161, 162, 163, 164, 165, 166, 167, 168, 170, 171, 172, 173, 174, 178, 181, 184, 185, 186, 188, 189, 196, 197, 198, 199, 200, 201, 202, 203, 204, 212, 215, 218, 219, 220, 222, 223, 230, 231, 232, 233, 234, 241, 242, 244, 245, 246, 247, 248, 255, 256, 257, 259, 260, 267, 268, 269, 271, 272]
  ...
  public void test_calcCartPromotion_00()  throws Throwable  {
      //caseID:e33a3e5051a146ae712a1fd083620edf
      ...
      doReturn("158").when(omsCartItem0).toString();
      ...
      doReturn("158").when(omsCartItem1).toString();
  ...
  public void test_calcCartPromotion_01()  throws Throwable  {
      //caseID:f20ce22bcf0dcf06d2f4b556827207f5
      ...
      doReturn(long0, long1).when(promotionProduct0).getId();
      doReturn(integer0).when(promotionProduct0).getPromotionType();
      doReturn("com.macro.mall.portal.service.impl.OmsPromotionServiceImpl$2", "3").when(promotionProduct0).toString();
      ...
      doReturn("29").when(omsCartItem0).toString();
  ...
  public void test_calcCartPromotion_02()  throws Throwable  {
      //caseID:f4cc0bcde799e83e54dd6f95d20149cc
  ...
  public void test_calcCartPromotion_03()  throws Throwable  {
      //caseID:a4779c652ad63a6d417cf09ec2e4e73f
  ...
  public void test_calcCartPromotion_04()  throws Throwable  {
      //caseID:eeae333309f23fad44f6975128343dde
      ...
      doReturn(long0).when(promotionProduct0).getId();
      doReturn(integer0).when(promotionProduct0).getPromotionType();
      doReturn("4", "4").when(promotionProduct0).toString();
      ...
      doReturn("4").when(omsCartItem0).getProductBrand();
      doReturn(long0).when(omsCartItem0).getProductCategoryId();
      doReturn(long0, long0, long0, long0).when(omsCartItem0).getProductId();
      doReturn("4").when(omsCartItem0).getProductName();
      doReturn("4").when(omsCartItem0).getProductPic();
      doReturn("4").when(omsCartItem0).getProductSkuCode();
      doReturn(long0, long0).when(omsCartItem0).getProductSkuId();
      doReturn("4").when(omsCartItem0).getProductSn();
      doReturn("4").when(omsCartItem0).getProductSubTitle();
      doReturn(integer0, integer0).when(omsCartItem0).getQuantity();
      doReturn("4").when(omsCartItem0).toString();
  ...
  public void test_calcCartPromotion_05()  throws Throwable  {
      //caseID:f76bfcd3396591d031947839d9d63ff0
      ...
      doReturn(bigDecimal0).when(pmsSkuStock0).getPrice();
      doReturn(integer0).when(pmsSkuStock0).getStock();
      doReturn("65535", "65535").when(pmsSkuStock0).toString();
      ...
      doReturn(integer0).when(promotionProduct0).getPromotionType();
      doReturn("65535", "65535", "65535").when(promotionProduct0).toString();
      ...
      //mock date0
      Date date0 = mock(Date.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("65535").when(date0).toString();
      //mock date1
      Date date1 = mock(Date.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("65535").when(date1).toString();
      //mock omsCartItem0
      OmsCartItem omsCartItem0 = mock(OmsCartItem.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      ...
      doReturn(long0).when(omsCartItem0).getId();
      doReturn(long0).when(omsCartItem0).getMemberId();
      doReturn("65535").when(omsCartItem0).getMemberNickname();
      doReturn(date1).when(omsCartItem0).getModifyDate();
      doReturn(bigDecimal0).when(omsCartItem0).getPrice();
      doReturn("65535").when(omsCartItem0).getProductAttr();
      doReturn("65535").when(omsCartItem0).getProductBrand();
      doReturn(long0).when(omsCartItem0).getProductCategoryId();
      doReturn(long0, long0, long0, long0, long0).when(omsCartItem0).getProductId();
      doReturn("65535").when(omsCartItem0).getProductName();
      doReturn("65535").when(omsCartItem0).getProductPic();
      doReturn("65535").when(omsCartItem0).getProductSkuCode();
      doReturn(long0, long0, long0).when(omsCartItem0).getProductSkuId();
      doReturn("65535").when(omsCartItem0).getProductSn();
      doReturn("65535").when(omsCartItem0).getProductSubTitle();
      doReturn(integer0, integer0).when(omsCartItem0).getQuantity();
      doReturn("65535").when(omsCartItem0).toString();
  ...
  public void test_calcCartPromotion_06()  throws Throwable  {
      //caseID:4cedf8e3dac21d7565f96f2d79b60a7b
      //CoveredLines: [25, 32, 34, 36, 37, 38, 39, 40, 41, 42, 59, 61, 62, 63, 64, 65, 66, 67, 68, 70, 71, 72, 73, 74, 75, 76, 77, 78, 82, 109, 110, 117, 118, 119, 120, 121, 128, 129, 130, 131, 132, 133, 134, 138, 139, 196, 197, 198, 199, 200, 201, 202, 203, 204, 212, 218, 219, 220, 230, 231, 232, 233, 234, 255, 256, 257, 259, 267, 268, 269]
      ...
      doReturn("4").when(pmsProductLadder0).toString();
      ...
      doReturn(bigDecimal0).when(pmsSkuStock0).getPrice();
      doReturn(integer0).when(pmsSkuStock0).getStock();
      doReturn("4").when(pmsSkuStock0).toString();
      Long long1 = new Long(2519L);
      //mock pmsSkuStock1
      ...
      //mock date0
      Date date0 = mock(Date.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("4").when(date0).toString();
      //mock date1
      Date date1 = mock(Date.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_calcCartPromotion_07()  throws Throwable  {
      //caseID:c720ef67a8bc70d424315e52e3c4aab1
      ...
      doReturn(integer0).when(pmsSkuStock0).getStock();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber", "reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(pmsSkuStock0).toString();
      ...
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(pmsProductFullReduction0).toString();
      ...
      doReturn(long0, long0).when(promotionProduct0).getId();
      doReturn(integer0).when(promotionProduct0).getPromotionType();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber", "reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber", "reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(promotionProduct0).toString();
      doReturn(linkedList0).when(promotionProduct0).getProductFullReductionList();
      doReturn(stack1, stack1).when(promotionProduct0).getSkuStockList();
      ...
      //mock date0
      Date date0 = mock(Date.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(date0).toString();
      //mock date1
      Date date1 = mock(Date.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(date1).toString();
      //mock omsCartItem0
      OmsCartItem omsCartItem0 = mock(OmsCartItem.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(date1).when(omsCartItem0).getCreateDate();
      doReturn(integer0).when(omsCartItem0).getDeleteStatus();
      doReturn(long0).when(omsCartItem0).getId();
      doReturn(long0).when(omsCartItem0).getMemberId();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getMemberNickname();
      doReturn(date0).when(omsCartItem0).getModifyDate();
      doReturn(bigDecimal0).when(omsCartItem0).getPrice();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getProductAttr();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getProductBrand();
      doReturn(long0).when(omsCartItem0).getProductCategoryId();
      doReturn(long0, long0, long0, long0, long0).when(omsCartItem0).getProductId();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getProductName();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getProductPic();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getProductSkuCode();
      doReturn(long0, long0, long0).when(omsCartItem0).getProductSkuId();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getProductSn();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).getProductSubTitle();
      doReturn(integer0, integer0).when(omsCartItem0).getQuantity();
      doReturn("reactor.core.publisher.FluxLimitRequest$FluxLimitRequestSubscriber").when(omsCartItem0).toString();
  ...
  public void test_getProductFullReduction_08()  throws Throwable  {
      //caseID:7d434bed711c0ca89cb51f94869e0fb9
      ...
      PmsProductFullReduction pmsProductFullReduction0 = mock(PmsProductFullReduction.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(bigDecimal0, bigDecimal0).when(pmsProductFullReduction0).getFullPrice();
      doReturn("14").when(pmsProductFullReduction0).toString();
      ...
      PmsProductFullReduction pmsProductFullReduction2 = (PmsProductFullReduction)PrivateAccess.callMethod((Class<OmsPromotionServiceImpl>) OmsPromotionServiceImpl.class, omsPromotionServiceImpl0, "getProductFullReduction", (Object) bigDecimal0, (Class<?>) BigDecimal.class, (Object) vector0, (Class<?>) List.class);
  ...
  public void test_getProductFullReduction_09()  throws Throwable  {
      //caseID:8b5ed6d3f0be28ebdf1d72a5f004d75c
  ...
  public void test_getProductLadder_10()  throws Throwable  {
      //caseID:ec27df35220de773c082ee7c0e80b8b7
      ...
      doReturn("3").when(pmsProductLadder1).toString();
      ...
      PmsProductLadder pmsProductLadder2 = (PmsProductLadder)PrivateAccess.callMethod((Class<OmsPromotionServiceImpl>) OmsPromotionServiceImpl.class, omsPromotionServiceImpl0, "getProductLadder", (Object) 3, (Class<?>) int.class, (Object) arrayList0, (Class<?>) List.class);
  ...
  public void test_getProductLadder_11()  throws Throwable  {
      //caseID:0031329c22b6fd0ec7f2f19f9f077f57
      ...
      //Call method: getProductLadder
      Object object0 = PrivateAccess.callMethod((Class<OmsPromotionServiceImpl>) OmsPromotionServiceImpl.class, omsPromotionServiceImpl0, "getProductLadder", (Object) 3, (Class<?>) int.class, (Object) linkedList0, (Class<?>) List.class);
