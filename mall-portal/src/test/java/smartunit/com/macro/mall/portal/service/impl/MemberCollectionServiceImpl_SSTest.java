...
// allCoveredLines:[21, 29, 30, 31, 32, 33, 34, 35, 36, 37, 39, 44, 45, 50, 51, 52, 57, 58, 63, 64, 65]
  ...
  public void test_add_0()  throws Throwable  {
      //caseID:19a92072445de199a44a06bacaaa4e56
      //CoveredLines: [21, 29, 30, 31, 32, 33, 34, 35, 39]
      //Input_0_MemberProductCollection: {getMemberId=0L, getProductId=0L}
  ...
  public void test_add_1()  throws Throwable  {
      //caseID:8d855741cf031efaffc75e263cfe841c
  ...
  public void test_clear_2()  throws Throwable  {
      //caseID:6cf4b2ee63c3d6d337ca446785165d7d
  ...
  public void test_delete_3()  throws Throwable  {
      //caseID:e20d5c31dc6b5007d421951eceabf80d
  ...
  public void test_detail_4()  throws Throwable  {
      //caseID:619178a29c4f6d8e8225f6911949de72
  ...
  public void test_list_5()  throws Throwable  {
      //caseID:8e74ab4b43bb7efe310f3522b72a5265
      //CoveredLines: [21, 50, 51, 52]
      //Input_0_Integer: 1443
      //Input_1_Integer: 1443
      //Assert: assertEquals(0, method_result.getNumberOfElements());
      ...
      doReturn("0").when(page0).toString();
      //mock memberProductCollectionRepository0
      MemberProductCollectionRepository memberProductCollectionRepository0 = mock(MemberProductCollectionRepository.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(page0).when(memberProductCollectionRepository0).findByMemberId(nullable(java.lang.Long.class) , nullable(org.springframework.data.domain.Pageable.class));
      ...
      //Call method: list
      Page<MemberProductCollection> page1 = memberCollectionServiceImpl0.list(integer0, integer0);
