...
public class OmsCartItemServiceImpl_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.portal.service.impl.OmsCartItemServiceImpl"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.mapper.OmsCartItemMapper", false, OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.model.OmsCartItem", false, OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.model.UmsMember", false, OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.portal.dao.PortalProductDao", false, OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.portal.service.OmsPromotionService", false, OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.portal.service.UmsMemberService", false, OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OmsCartItemServiceImpl_SSTest_scaffolding.class.getClassLoader()); 
