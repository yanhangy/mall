...
public class MemberProductCollectionController_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.portal.controller.MemberProductCollectionController"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.portal.domain.MemberProductCollection", false, MemberProductCollectionController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.portal.service.MemberCollectionService", false, MemberProductCollectionController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.data.domain.Page", false, MemberProductCollectionController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(MemberProductCollectionController_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MemberProductCollectionController_SSTest_scaffolding.class.getClassLoader()); 
