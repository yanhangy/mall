...
public class OmsPortalOrderReturnApplyServiceImpl_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.macro.mall.portal.service.impl.OmsPortalOrderReturnApplyServiceImpl"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.macro.mall.mapper.OmsOrderReturnApplyMapper", false, OmsPortalOrderReturnApplyServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.macro.mall.portal.domain.OmsOrderReturnApplyParam", false, OmsPortalOrderReturnApplyServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(OmsPortalOrderReturnApplyServiceImpl_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OmsPortalOrderReturnApplyServiceImpl_SSTest_scaffolding.class.getClassLoader()); 
